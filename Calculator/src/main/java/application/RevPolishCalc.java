...
public class RevPolishCalc {
  ...
  private static final String DIVIDE_BY_ZERO_EXCEPTION = "Error: Current input divides by 0";
   ...
   * @throws InvalidExpressionException if parameter includes an invalid symbol, character or is
   *         empty
   */
